...
class TestGithubOrgClient(unittest.TestCase):
    ...
    def test_org(self, org_name, mock_json):
        """ Test method thatreturns correct output """
    ...
    def test_public_repos_url(self, name, result):
        """ Test method_returns correct output """
    ...
    def test_has_license(self, repo, license_key, expected):
        """ unit-test_GithubOrgClient.has_license """
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    """ Class for Integration test_fixtures """
    ...
    def test_public_repos_with_license(self):
        """ Integration test> public repositories with License """
        test_class = GithubOrgClient("google")
    ...
    def tearDownClass(cls):
        """A class method called after individual class have run"""
